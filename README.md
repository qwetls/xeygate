...
<p>
  <a href="https://github.com/qwetls/xeygate/releases"><img src="https://img.shields.io/badge/version-v1.2.0-6366f1?style=flat-square" alt="Version"></a>
...
- **Public Legal Pages:** `/terms`, `/privacy`, `/acceptable-use` and `/refund` — tailored to how the platform actually runs (prepaid credits, admin-confirmed top-ups, third-party model routing, marketplace conduct). Linked from the landing footer's **Legal** column and the sign-up consent line.
